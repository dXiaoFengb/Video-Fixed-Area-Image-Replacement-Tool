...
首帧预览支持主窗口框选，以及“放大预览”独立窗口。放大窗口支持适应窗口与连续 50%～400% 鼠标锚点缩放、滑块同步、右键平移和拖动期间 2.5 倍放大镜、Ctrl+滚轮、滚动条和 F11 全屏；Esc 只退出全屏，关闭按钮关闭预览窗口。两个窗口共享同一归一化选区。
