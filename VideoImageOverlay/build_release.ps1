...
python -m PyInstaller --noconfirm --clean --onefile --windowed --name VideoImageOverlay --workpath build\work --specpath build\spec --distpath . --add-binary "$ffmpeg;." --add-binary "$ffprobe;." --add-data "$license;." main.py
